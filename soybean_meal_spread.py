...
SMF_H_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMF-H')
SMH_K_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMH-K')
SMK_N_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMK-N')
SMN_Q_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMN-Q')
SMQ_U_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMQ-U')
SMU_V_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMU-V')
SMV_Z_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMV-Z')
SMZ_F_df=pd.read_excel("soybean_meal_spread.xlsx",sheet_name='SMZ-F')
