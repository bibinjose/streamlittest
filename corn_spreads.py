...
corn_spreads = { 
    ...
    'CZ-H': {
        'description':'Corn Dec-Mar',
        'data': CZ_H_df,
        'y1a1':['2022 CZ-H CLOSE','2021 CZ-H CLOSE','CZ-H CLOSE 5 yr Avg','CZ-H CLOSE 10 yr Avg'],
        'y1a2':['2022 CZ-H CLOSE','2021 CZ-H CLOSE','CZ-H CLOSE 5 yr Avg','CZ-H CLOSE 10 yr Avg','SMA10_CZ-H_Close_5yr',
        ...
        'y1a3':['2017 CZ-H CLOSE','2018 CZ-H CLOSE','2019 CZ-H CLOSE','2020 CZ-H CLOSE',
                '2021 CZ-H CLOSE','2022 CZ-H CLOSE','CZ-H CLOSE 5 yr Avg'],
        'y1b1':['2022 CZ-H VOLUME','2021 CZ-H VOLUME','CZ-H VOLUME 5 yr Avg','CZ-H VOLUME 10 yr Avg'],
        'y1b2':['2022 CZ-H VOLUME','2021 CZ-H VOLUME','CZ-H VOLUME 5 yr Avg','CZ-H VOLUME 10 yr Avg','SMA10_CZ-H_Vol_5yr',
        ...
        'y1b3':['2017 CZ-H VOLUME','2018 CZ-H VOLUME','2019 CZ-H VOLUME','2020 CZ-H VOLUME',
                '2021 CZ-H VOLUME','2022 CZ-H VOLUME','CZ-H VOLUME 5 yr Avg'],
        'y2a1':['2022 CZ-H CLOSE','2021 CZ-H CLOSE','CZ-H CLOSE 5 yr Avg','CZ-H CLOSE 10 yr Avg'],
        'y2b1':['2022 CZ OpenInt','2021 CZ OpenInt','CZ OpenInt 5 yr Avg','CZ OpenInt 10 yr Avg'],
        'y2a2':['2022 CZ-H CLOSE','2021 CZ-H CLOSE','CZ-H CLOSE 5 yr Avg','CZ-H CLOSE 10 yr Avg','SMA10_CZ-H_Close_5yr',
                'SMA20_CZ-H_Close_5yr','SMA10_CZ-H_Close_10yr','SMA20_CZ-H_Close_10yr'],
        'y2b2':['2022 CZ OpenInt','2021 CZ OpenInt','CZ OpenInt 5 yr Avg','CZ OpenInt 10 yr Avg','SMA10_CZ_OpenInt_5yr',
        ...
        'y2b3':['2017 CZ OpenInt','2018 CZ OpenInt','2019 CZ OpenInt','2020 CZ OpenInt',
                '2021 CZ OpenInt','2022 CZ OpenInt','CZ OpenInt 5 yr Avg'],
        'x_value':'2022 Dates'
        
    },
    'CN-U': {
        'description':'Corn Jul-Sep',
        'data': CN_U_df,
