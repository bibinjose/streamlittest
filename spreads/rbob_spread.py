...
RBF_J_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBF-J')
RBG_K_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBG-K')
RBF_K_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBF-K')
RBG_J_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBG-J')


#Regular Spreads
RBF_G_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBF-G')
RBG_H_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBG-H')
RBH_J_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBH-J')
RBJ_K_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBJ-K')
RBK_M_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBK-M')
RBM_N_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBM-N')
RBN_Q_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBN-Q')
RBQ_U_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBQ-U')
RBU_V_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBU-V')
RBV_X_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBV-X')
RBX_Z_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBX-Z')
RBZ_F_df=pd.read_excel("rbob_spread_data.xlsx",sheet_name='RBZ-F')
